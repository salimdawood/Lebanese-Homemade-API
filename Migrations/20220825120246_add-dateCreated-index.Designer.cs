...
namespace LebaneseHomemade.Migrations
{
    ...
    [Migration("20220825120246_add-dateCreated-index")]
            ...
            modelBuilder.Entity("LebaneseHomemadeLibrary.CardModel", b =>
                {
                    ...
                    b.HasIndex("DateCreated")
                        .IsClustered(false)
                        .IncludeProperties(new[] { "Title", "FaceBookLink", "InstagramLink", "WhatsAppLink", "TypeId", "UserId" });

                    b.HasIndex("TypeId")
                        .IsClustered(false)
                        .IncludeProperties(new[] { "Title", "DateCreated", "FaceBookLink", "InstagramLink", "WhatsAppLink", "UserId" });

                    b.HasIndex("UserId")
                        .IsClustered(false)
                        .IncludeProperties(new[] { "Title", "DateCreated", "FaceBookLink", "InstagramLink", "WhatsAppLink", "TypeId" });
            ...
            modelBuilder.Entity("LebaneseHomemadeLibrary.ItemModel", b =>
                {
                    ...
                    b.HasIndex("MenuId")
                        .IsClustered(false)
                        .IncludeProperties(new[] { "Name", "Price" });
